...
//                     final outtime =
//                         it.outTime != null
//                             ? _formatShortDate(it.outTime.toString())
//                             : null;
...
//                                     if (draftTickets.contains(noTicket))
//                                       Container(
...
//                                 Text(
//                                   '$driver • ${productName.isNotEmpty ? productName : '-'}',
//                                   style: TextStyle(
//                                     color: textGrey,
//                                     fontSize: 12,
//                                   ),
...
//                                 style: TextStyle(color: textGrey),
//                               )
//                             else if (it.customerId != 0)
//                               Text(
//                                 'Customer: ${it.customerId}',
//                                 style: TextStyle(color: textGrey),
//                               ),
//                             if (doNo != null && doNo.isNotEmpty)
//                               Text(
//                                 'No DO: $doNo',
//                                 style: TextStyle(color: textGrey),
//                               ),
...
//                       style: TextStyle(
//                         color: textGrey.withAlpha((0.9 * 255).round()),
//                       ),
//                     ),
//                   ),
//                 );
...
//                                   ),
//                                   const SizedBox(width: 8),
//                                   if (draftTickets.contains(tx.noTicket))
//                                     Container(
//                                       padding: const EdgeInsets.symmetric(
//                                         horizontal: 8,
//                                         vertical: 4,
...
//                               'Bruto',
//                               style: TextStyle(
//                                 color: textGrey.withAlpha((0.7 * 255).round()),
//                                 fontSize: 10,
//                               ),
//                             ),
//                           ],
